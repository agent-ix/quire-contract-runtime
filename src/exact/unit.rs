...
//! quire-specification/FR-142 dimensions, declared units, their admitted unit graph and normalized
//! compound units.
//!
...
/// identity.
// Fields behind one `Box` (IR-286): `ValueType::Quantity` carries this type
