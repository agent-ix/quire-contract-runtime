...
/// when it does not (IR-286): the representation is canonical, so equality,
/// hashing and ordering are those of the mathematical value, and no operation
/// here narrows, wraps or saturates. An inline value keeps the common case free
