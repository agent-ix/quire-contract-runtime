...
SUITE-005, SUITE-006 and SUITE-008 were previously performed by the deleted
...
SUITE-007 was the retained-evidence compatibility view. It went with the records
it read, under `agent-ix/quire-contract-runtime#11`. Its id is not reused.
