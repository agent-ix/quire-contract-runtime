...
/// Evaluate paired `div`/`rem` under the package law the compiler admitted.
///
/// Selecting and admitting exactly one law is semantic admission; the runtime
/// receives only its admitted [`DivisionProfile`].
pub fn divide(
