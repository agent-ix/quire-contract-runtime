#!/usr/bin/env python3
"""Read this repository's retained evidence through the pinned shared mapping (FR-005-AC-4).
...
It is not a verifier. It replaces `verify_evidence.py`, `check_assurance_anchor.py`
and `update_evidence_anchors.py`, and it does not inherit their job. It does not
...
It is not a translator of last resort. This repository's 42 retained envelopes
...
def census(mapper: Callable[..., dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        "schemaVersion": "quire-contract-runtime.legacy-compatibility-census/v1",
        "mapping_authority": (
            "engineering_assurance.verification_semantics.map_pgm01_bytes from the pinned "
